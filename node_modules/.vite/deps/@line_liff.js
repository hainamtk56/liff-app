...
var extendStatics = function(d7, b8) {
  extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d8, b9) {
    d8.__proto__ = b9;
  } || function(d8, b9) {
    for (var p12 in b9) if (Object.prototype.hasOwnProperty.call(b9, p12)) d8[p12] = b9[p12];
  };
  return extendStatics(d7, b8);
};
function __extends(d7, b8) {
  ...
  d7.prototype = b8 === null ? Object.create(b8) : (__.prototype = b8.prototype, new __());
}
...
function v3(e10, n6, i6) {
  ...
  return d7 && !s11 ? { available: false, error: { code: E, message: "".concat(t2, " is unavailable in this client version.") } } : a10.permission ? d7 && s11 || n6 ? { available: true } : { available: false, error: { code: E, message: "".concat(t2, " is not allowed in external browser") } } : { available: false, error: { code: E, message: "".concat(t2, " is not allowed in this LIFF app") } };
}
var g4 = function() {
...
var p7 = function(e10, s11, r10) {
  return __awaiter(void 0, void 0, void 0, function() {
    var t2, o7, c14, d7;
    return __generator(this, function(n6) {
      switch (n6.label) {
        case 0:
          return n6.trys.push([0, 3, , 4]), t2 = new TextEncoder().encode(e10), [4, v4(s11)];
        case 1:
          return o7 = n6.sent(), [4, window.crypto.subtle.encrypt({ name: "AES-GCM", iv: t2 }, o7, new TextEncoder().encode(r10))];
        case 2:
          return c14 = n6.sent(), [2, btoa(new Uint8Array(c14).reduce(function(e11, t3) {
            return e11 + String.fromCharCode(t3);
          }, ""))];
        case 3:
          throw d7 = n6.sent(), w(e2, d7);
        case 4:
          return [2];
      }
    });
...
var m6 = function(e10, s11, r10) {
  return __awaiter(void 0, void 0, void 0, function() {
    var t2, o7, c14, d7, u13, f14, l13;
    return __generator(this, function(n6) {
      switch (n6.label) {
        case 0:
          return n6.trys.push([0, 3, , 4]), t2 = new TextEncoder().encode(e10), [4, v4(s11)];
        case 1:
          for (o7 = n6.sent(), c14 = atob(r10), d7 = new Uint8Array(c14.length), u13 = 0; u13 < c14.length; u13++) d7[u13] = c14.charCodeAt(u13);
...
var E4 = function(r10) {
  ...
  this.identification = { identifier: "", cryptoKey: "" }, this.messageHandlerInstance = null, this.listeners = /* @__PURE__ */ new Map(), this.sentMessages = [], this.generateIdentification = function() {
    return __awaiter(o7, void 0, void 0, function() {
      var e10, r11, o8, d7, u13;
      return __generator(this, function(l13) {
        switch (l13.label) {
          case 0:
            return e10 = new URLSearchParams(window.location.search), r11 = function(t2) {
              var n6 = e10.get("liff.state");
              return n6 ? new URLSearchParams(n6).get(t2) : null;
            }, o8 = this, u13 = { identifier: this.windowType === f6.MAIN ? x(12) : e10.get("liff.subwindow.identifier") || r11("liff.subwindow.identifier") || "" }, this.windowType !== f6.MAIN ? [3, 2] : [4, __awaiter(void 0, void 0, void 0, function() {
              var e11, t2, s11;
              return __generator(this, function(n6) {
                switch (n6.label) {
                  case 0:
          ...
          case 1:
            return d7 = l13.sent(), [3, 3];
          case 2:
            d7 = e10.get(c8) || r11(c8) || "", l13.label = 3;
          case 3:
            return o8.identification = (u13.cryptoKey = d7, u13), [2];
        }
      });
    });
    ...
    return __awaiter(o7, void 0, void 0, function() {
      var e10, t2, s11, r11, o8, c14 = this;
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
          ...
          case 1:
            ...
            return (s11 = document.createElement("iframe")).style.display = "none", s11.src = "about:blank", document.body.appendChild(s11), null === (o8 = null == s11 ? void 0 : s11.contentWindow) || void 0 === o8 || o8.window.eval("(".concat(b4.toString().replace("$MESSAGE_HANDLER_URL", "".concat("https://liff-subwindow.line.me/liff/v2/sub/messageHandler")).replace("$IDENTIFIER", e10.split("'")[0]), ")()")), r11 = "iframe-".concat(e10, "-ready"), [4, new Promise(function(e11) {
              var t3 = function(n7) {
                n7.data[r11] && (c14.messageHandlerInstance = s11, window.addEventListener("message", c14.proxyToListeners), e11(), document.removeEventListener("message", t3));
              };
    ...
    return __awaiter(o7, void 0, void 0, function() {
      var t2, s11, r11, a10, o8 = this;
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            if (!this.isReady()) throw w("message bus is not ready to send message");
            return s11 = { action: g5(e10.eventName), identifier: this.identification.identifier || "", timestamp: (/* @__PURE__ */ new Date()).getTime() }, [4, this.getEncryptedContext(e10)];
          case 1:
            return s11.context = n6.sent(), t2 = s11, null === (a10 = null === (r11 = this.messageHandlerInstance) || void 0 === r11 ? void 0 : r11.contentWindow) || void 0 === a10 || a10.postMessage({ messageBusEvent: t2 }, "*"), this.sentMessages.push(y4(t2)), [4, new Promise(function(e11) {
      ...
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            ...
            return r11 = { action: u6.BROADCAST }, [4, this.getEncryptedContext(s11)];
          case 1:
            return r11.context = n6.sent(), r11.identifier = this.identification.identifier || "", r11.timestamp = (/* @__PURE__ */ new Date()).getTime(), r11.replyTarget = { action: e10.action, identifier: e10.identifier, timestamp: e10.timestamp }, t2 = r11, null === (c14 = null === (o8 = this.messageHandlerInstance) || void 0 === o8 ? void 0 : o8.contentWindow) || void 0 === c14 || c14.postMessage({ messageBusEvent: t2 }, "*"), this.sentMessages.push(y4(t2)), [2];
        }
      });
    });
    ...
    return __awaiter(o7, void 0, void 0, function() {
      ...
      return __generator(this, function(a10) {
        return s11 = i6.data.messageBusEvent, "https://liff-subwindow.line.me" !== i6.origin ? [2] : s11 ? (this.sentMessages.includes(y4(s11)) || s11.identifier !== this.identification.identifier || s11.action !== u6.BROADCAST && !s11.replyTarget || this.listeners.forEach(function(i7) {
          return __awaiter(r11, void 0, void 0, function() {
            var t2, r12, a11;
            return __generator(this, function(n6) {
              switch (n6.label) {
                case 0:
                  return t2 = i7, r12 = [__assign({}, s11)], a11 = {}, [4, this.getDecryptedContext(s11.context)];
                case 1:
                  return t2.apply(void 0, [__assign.apply(void 0, r12.concat([(a11.context = n6.sent(), a11)]))]), [2];
              }
            });
          });
        }), [2]) : [2];
    ...
    return __awaiter(o7, void 0, void 0, function() {
      var t2, i6, s11, r11, a10, o8, c14;
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            return t2 = this.identification, i6 = t2.identifier, s11 = t2.cryptoKey, a10 = (r11 = JSON).stringify, c14 = { eventName: e10.eventName, key: e10.key ? e10.key : void 0 }, e10.data ? [4, p7(i6, s11, JSON.stringify(e10.data))] : [3, 2];
          case 1:
            return o8 = n6.sent(), [3, 3];
          case 2:
            o8 = void 0, n6.label = 3;
          case 3:
            return [2, a10.apply(r11, [(c14.data = o8, c14)])];
        }
      });
    });
  }, this.getDecryptedContext = function(i6) {
    return __awaiter(o7, void 0, void 0, function() {
      var t2, s11, r11, a10, o8, c14, d7, u13;
      return __generator(this, function(n6) {
        switch (n6.label) {
          case 0:
            return t2 = this.identification, s11 = t2.identifier, r11 = t2.cryptoKey, (a10 = JSON.parse(i6)).data && "string" == typeof a10.data ? (u13 = (d7 = JSON).parse, [4, m6(s11, r11, a10.data)]) : [3, 2];
          case 1:
            return c14 = u13.apply(d7, [n6.sent()]), [3, 3];
          case 2:
...
!function() {
  if ("undefined" != typeof window && "function" != typeof window.CustomEvent) {
    let t2 = function(t3, e10) {
      var i6 = e10 || {}, o7 = i6.bubbles, n6 = void 0 !== o7 && o7, a10 = i6.cancelable, r10 = void 0 !== a10 && a10, d7 = i6.detail, l13 = void 0 === d7 ? void 0 : d7, f14 = document.createEvent("CustomEvent");
...
function p8(t2, a10, d7) {
  void 0 === a10 && (a10 = {}), void 0 === d7 && (d7 = "");
  var l13 = w2();
  ...
  i.debug("[js postMessage to client]", t2, d7, a10), window._liff.postMessage(t2, l13, d7, JSON.stringify(a10));
}
function w5(t2, e10, l13) {
  return void 0 === e10 && (e10 = {}), void 0 === l13 && (l13 = { once: true }), w2() ? (l13 = __assign({ callbackId: x(12), once: true }, l13), new Promise(function(i6, n6) {
    var a10 = function(e11) {
      if (e11 && e11.detail) {
        var r10 = e11.detail.callbackId === l13.callbackId, d7 = "string" != typeof e11.detail.callbackId;
        (r10 || d7) && (l13.once && u7(t2, a10), i.debug("[callback detail]", e11.detail), e11.detail.error ? n6(e11.detail.error) : e11.detail.data ? i6(e11.detail.data) : n6(e11.detail));
      }
      n6();
    };
...
function Ne(e10) {
  var t2 = e10.iconColor, r10 = e10.statusBarColor, n6 = e10.titleTextColor, o7 = e10.titleSubtextColor, i6 = e10.titleButtonColor, a10 = e10.titleBackgroundColor, c14 = e10.progressBarColor, s11 = e10.progressBackgroundColor, u13 = e10.titleButtonAreaBackgroundColor, d7 = e10.titleButtonAreaBorderColor, h6 = e10.baseBackgroundColor, p12 = e10.baseTextColor, v7 = e10.lightButtonBorderColor;
  De("--liff-base-background-color", h6), De("--liff-base-text-color", p12), De("--liff-base-background-rgb-color", d(h6)), De("--liff-base-text-rgb-color", d(p12)), De("--liff-light-button-border-color", v7), De("--liff-title-text-color", n6), De("--liff-title-background-color", a10), De("--liff-title-button-color", i6), De("--liff-icon-color", t2), De("--liff-status-bar-color", r10), De("--liff-title-subtext-color", o7), De("--liff-progress-bar-color", c14), De("--liff-progress-background-color", s11), De("--liff-title-button-area-background-color", s3(u13)), De("--liff-title-button-area-border-color", s3(d7));
}
function De(e10, t2) {
...
function je(e10, o7) {
  return __awaiter(this, void 0, void 0, function() {
    var t2, i6, a10, c14, s11, l13, f14, p12, v7, m10, w7, g10, b8, k4, C7, F4;
    return __generator(this, function(r10) {
      switch (r10.label) {
        case 0:
        ...
        case 5:
          if (g10) {
            if (k4 = f14.iss !== "https://access.".concat("line.me"), C7 = f14.aud !== o7, F4 = 1e3 * f14.exp < Date.now(), k4) throw w(T, 'Invalid "iss" value in ID_TOKEN');
            if (C7) throw w(T, 'Invalid "aud" value in ID_TOKEN');
...
function Qe(e10) {
  var n6, o7;
  return __awaiter(this, void 0, void 0, function() {
    var t2, i6, a10, c14, l13, f14, d7, h6, v7, g10, b8, C7, F4, I7, y6, _5, B3;
    return __generator(this, function(r10) {
      switch (r10.label) {
        case 0:
        ...
        case 2:
          if (t2 = r10.sent(), i6 = t2.access_token, a10 = t2.context_token, c14 = t2.feature_token, l13 = t2.id_token, f14 = t2.client_id, d7 = t2.mst_verifier, h6 = t2.mst_challenge, v7 = t2.msit, a10) {
          ...
          }(e10.liffId, c14), Ve() && U3(c14)), h6 && R3(h6), d7 && A3(d7), f14 && F2(f14), v7 && C3(v7), window.addEventListener("pageshow", Ge), e3() ? [3, 5] : c14 && i6 ? [3, 5] : Ve() ? (g10 = E2(location.href, { "liff.hback": "2" }), _3({ redirectUri: g10 }), [4, new Promise(function() {
          })]) : [3, 4];
        case 3:
        ...
        case 6:
          if (b8 = r10.sent(), C7 = b8.client_id, F4 = b8.expires_in, I7 = m2(e10.liffId), C7 !== I7) throw _3(), w(I, "Failed to verify access_token");
...
var et2 = new (function() {
  function e10() {
    ...
    this.getAndValidateContext = function() {
      ...
      t2 = t2.replace(/\n/g, "%0D%0A");
      var n6 = !r10.endpointUrl.startsWith("/?") && r10.endpointUrl.includes("/?") || !r10.endpointUrl.startsWith("/#") && r10.endpointUrl.includes("/#") || r10.endpointUrl.endsWith("/") || !t2.startsWith("/?") && t2.includes("/?") || !t2.startsWith("/#") && t2.includes("/#") || t2.endsWith("/"), o7 = new URL(r10.endpointUrl), i6 = o7.origin, a10 = o7.pathname, c14 = o7.search, s11 = new URL("".concat(i6).concat(e11.attachSlashAtStart(t2))), l13 = s11.pathname, f14 = s11.search, u13 = s11.hash, d7 = "".concat(c14).concat(c14 ? f14.replace(/\?/g, "&") : f14), h6 = "".concat(a10).concat(e11.attachSlashAtStart(l13)).replace("//", "/");
      return (h6 = e11.attachSlashAtStart("".concat(h6))).endsWith("/") && !n6 && (h6 = h6.substring(0, h6.length - 1)), "".concat(i6).concat(h6).concat(d7).concat(u13).replace(/%0D%0A/g, "\n");
    };
  }
...
function p10(n6) {
  ...
  if (u3()) if (null !== u13 && "ios" === e6() && f2(u13, "9.19") >= 0 || !window._liff.postMessage) {
    ...
    window.open(function(n7, t2) {
      ...
      var d8 = a8(s12, p13);
      return "".concat(u14, "?").concat("is_liff_external_open_window", "=").concat(!!t2).concat(d8);
    }(p12, d7));
...
var I4 = function(u13) {
  ...
  return __extends(d7, u13), Object.defineProperty(d7, "CUSTOMPLACEID_INIT", { get: function() {
    return "liff.init";
    ...
    return __awaiter(this, void 0, void 0, function() {
      var t2, i6, r10, u14, d8, h6, g10, I7, m10, L6, S7, v7;
      return __generator(this, function(e10) {
        switch (e10.label) {
          case 0:
            if (t2 = A2.parse(window.location.search), this.prepareReferrer(t2), i6 = E3(), !(r10 = null == i6 ? void 0 : i6.utsTracking)) return [2];
            if (u14 = c5(), d8 = u14.liffId, h6 = u14.analytics, "auto" !== r10.mode || !h6) return [3, 6];
          ...
          case 5:
            (S7 = e10.sent()) && (i.debug("[LIFFUTS][mid] ".concat(S7)), this.uts.setMid(S7)), (null == i6 ? void 0 : i6.tid) && (i.debug("[LIFFUTS][tid] ".concat(i6.tid)), this.uts.setTid(i6.tid)), this.referrer && (i.debug("liff.ref.referrer", this.referrer), this.uts.setSessionParams(this.referrer)), d8 && this.setLiffId(d8), this.setIsLoggedIn(e3()), this.setVersion(r4()), v7 = C2(location.href), i.debug("[LIFFUTS][url] ".concat(v7)), this.uts.setUrl(v7), this.liffCore.analytics = this.uts, this.injected = true, e10.label = 6;
          case 6:
            return [2];
        }
      });
...
var g8 = /([\x90\x9D\x81\x8D\x8F<"{|}>\\^`“›„•‚ŽŠ…’—ž–‘”‡™‰ŒšŸ‹œ†¥¿©áÄýÍÎðô]|\n|.*#.*#|%(?![0-9A-Fa-f]{2})[^%]{0,2})/;
var v6 = function(n6) {
  if (g8.test(n6)) throw w(i3, "invalid URL.");
  var t2 = new URL(n6), r10 = t2.username, e10 = t2.password, i6 = t2.hash, a10 = t2.search;
  return { username: r10, password: e10, pathname: t2.pathname, hash: i6, origin: t2.origin, search: a10 };
};
var w6 = function(n6) {
...
var y5 = function(e10, i6) {
  var a10 = function(r10, e11) {
    for (var i7 = __spreadArray([], __read(r10), false), a11 = 0; a11 < e11.length; a11++) {
      var o7 = e11[a11], c14 = i7.indexOf(o7);
      c14 > -1 && i7.splice(c14, 1);
    }
    return i7;
  }(function(n6) {
    var e11, i7, a11 = n6.replace(/\+/g, "%2B"), o7 = new URLSearchParams(a11), c14 = [];
    try {
      for (var u13 = __values(o7.entries()), s11 = u13.next(); !s11.done; s11 = u13.next()) {
        var f14 = __read(s11.value, 2), l13 = f14[0], h6 = f14[1];
        c14.push("".concat(U4(l13), "=").concat(U4(h6)));
      }
    } catch (m10) {
      e11 = { error: m10 };
    } finally {
      try {
        s11 && !s11.done && (i7 = u13.return) && i7.call(u13);
      } finally {
        if (e11) throw e11.error;
      }
    }
    if (0 === c14.length) return [""];
    var p12 = n6.split("&");
    return c14.map(function(n7, t2) {
      return n7.endsWith("=") && !p12[t2].endsWith("=") ? n7.slice(0, -1) : n7;
    });
  }(w6(e10).join("&")), w6(i6)).join("&");
...
var L4 = function(n6, t2) {
  var r10 = v6(n6), e10 = new URL(t2);
  if (r10.username !== e10.username || r10.password !== e10.password) throw w(i3, "invalid URL.");
  if (e10.origin !== r10.origin || !C5(e10.pathname, r10.pathname)) throw w(i3, "invalid URL.");
};
var P4 = function(n6) {
  function t2() {
    ...
    return t3.extraParams = "", t3.getAndValidateContext = function() {
      ...
      var n7 = t3.getAndValidateContext(), r10 = window.location, e10 = r10.pathname, i6 = r10.search, a10 = r10.hash, o7 = r10.origin, u13 = new URL(n7.endpointUrl);
      if (u13.origin !== o7 || !C5(u13.pathname, e10)) throw w(n3, "Current page is not under entrypoint.");
      var l13 = e10.substring(u13.pathname.length);
      l13.length > 0 && "/" !== l13[0] && (l13 = "/" + l13);
      var p12 = new RegExp("^".concat(D.join("|"))), d7 = a10.substring(1).split("&").filter(function(n8) {
        return !p12.test(n8) && Boolean(n8);
      }).join("&"), g10 = d7 === u13.hash.substring(1) ? "" : d7, v7 = function(n8) {
        return n8.substring(1).split("&").filter(function(n9) {
          return !/liff\.state/.test(n9) && Boolean(n9);
        });
      }, w7 = v7(i6), x6 = v7(u13.search);
      t3.extraParams && w7.push(t3.extraParams);
      for (var U6 = 0; U6 < x6.length; U6++) {
        var y6 = x6[U6], b8 = w7.indexOf(y6);
        b8 > -1 && w7.splice(b8, 1);
      }
      var L6 = w7.join("&"), P6 = "".concat(l13).concat("" !== L6 ? "?".concat(L6) : "").concat(g10 ? "#".concat(g10) : "");
      return "".concat(s2).concat(c5().liffId).concat(P6);
    }, t3.createUrlBy = function(n7) {
      return __awaiter(t3, void 0, void 0, function() {
        var t4, r10, e10, i6, o7, c14;
        return __generator(this, function(a10) {
          if (!(t4 = c5().liffId)) throw w(I, "Should run after liff init.");
          return r10 = this.getAndValidateContext(), L4(n7, r10.endpointUrl), e10 = v6(n7), i6 = new URL(r10.endpointUrl), o7 = r10.miniDomainAllowed ? a2 : s2, c14 = r10.miniDomainAllowed && r10.miniAppId ? r10.miniAppId : t4, [2, o7.concat(c14, x4(e10.pathname, i6.pathname), y5(e10.search, i6.search), b7(e10.hash))];
        });
      });
